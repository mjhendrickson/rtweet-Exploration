...
r4ds_count <- get_timeline(c("R4DScommunity"), n = 1)
r4ds_count$statuses_count # = 2836
...
mh_count <- get_timeline(c("mjhendrickson"), n = 1)
mh_count$statuses_count # = 1419
rm(mh_count) # Removes r4ds_count dataframe
