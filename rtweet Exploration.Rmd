...
r4ds_count$statuses_count # Get number of Tweets (statuses) = 6073 as of 2020/02/01
...
mh_count$statuses_count # Get number of Tweets (statuses) = 1723 as of 2020/02/01
...
I don't re-Tweet through Buffer. Of Tweets from my phone, the majority are re-Tweets. The majority of my Tweets from the browser are original.
